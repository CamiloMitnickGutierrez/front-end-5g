                            ...
                            <Box sx={{ display: 'flex', flexWrap: 'wrap', mx: -1 }}>
                                ...
                                <Box sx={{ width: '100%', px: 1, mt: 1 }}>
                                    <Button
                                        ...
                                        sx={{ py: 1.5, backgroundColor: '#19428a', color: '#fff', fontWeight: 'bold', '&:hover': { backgroundColor: '#143670' } }}
                                    >
                                        {cargando ? <CircularProgress size={24} sx={{ color: 'white'}} /> : "FINALIZAR REGISTRO y Guarda El  Codigo QR (Que te sale a continuacion)"}
                                    </Button>
                                </Box>
                            </Box>
                        </form>
